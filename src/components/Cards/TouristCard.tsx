...
const TouristCard: FC<Tourist> = (props) => {
  ...
  return (
    <div
      className="border border-gray-50 shadow rounded-md p-6 w-full bg-white flex flex-col justify-center md:justify-start md:flex-row gap-3 flex-1 items-center"
      key={id}
    >
      <img
      ...
      <div className="text-center md:text-left space-y-1">
        ...
        <p className="text-sm break-all md:break-normal text-black-secondary text-opacity-60">
          {tourist_email}
        </p>
